...
Object.assign(partnerAdventureScenes, { adv1: buildAdvScene('adv1', [
  ...
  '主人公「少しは。プリンターの場所で迷わなくなった」\n' +
  '同僚「それは大きな進歩ですね」\n' +
  '主人公「この部署の迷宮度が高いんだよ」\n' +
  '同僚は軽く笑う。\n' +
  '彼女はまだ何も覚えていない。\n' +
  'けれど、主人公にとっては、失いたくない相手だった。\n' +
...
Object.assign(partnerAdventureScenes, { adv3Dream: buildAdvScene('adv3Dream', [
  ...
  '主人公「僕は、君と前にもこのオフィスで働いていた記憶がある」\n' +
  '同僚「前にも？」\n' +
  '主人公「ああ。配置換えで初めて会ったはずなのに、僕は君のことを知っていた」\n' +
  '同僚「それは……夢、ですか？」\n' +
  '主人公「夢として覚えてる。でも、ただの夢じゃない」\n' +
  '主人公は窓を見る。\n' +
  '夜のガラスに、二人の姿が映っていた。\n' +
  '主人公「最後に、窓の外から黒い影が迫ってきた。君が襲われて、僕も止めようとして、でも倒れた」\n' +
  '同僚の表情から、軽さが消える。\n' +
  '同僚「どうして、それを今まで黙っていたんですか？」\n' +
  '主人公「信じてもらえると思えなかった。それに、君を怖がらせたくなかった」\n' +
  '同僚「……今は？」\n' +
  '主人公「このまま黙っていたら、また失う気がする」'
], [
  {
    label: '「夢の話を続ける」',
    effects: () => {},
    outcomePages: [
      '主人公「あれは前世か、前回のループかもしれない。少なくとも、僕たちは一度あの影に負けてる」\n' +
      '同僚「私は覚えていません。でも……」\n' +
      '彼女は窓を見た。\n' +
      '同僚「今、少しだけ怖いです。知らないはずなのに、あの窓の外が」\n' +
      '主人公「なら、完全には消えてない」\n' +
      '同僚「……そうかもしれません」'
    ],
...
Object.assign(partnerAdventureScenes, { dreamRoute: buildLinearScene('dream', [
  ...
  '同じ残業。\n' +
  '同じ窓。\n' +
  'そして、窓の外から迫ってきた名状しがたい黒い影。\n' +
  '同僚「私は覚えていません。でも、聞いているだけで、胸がざわつきます」\n' +
  '主人公「記憶は消えていても、どこかに残ってるのかもしれない」\n' +
  'その時、窓の外がわずかに暗くなった。\n' +
  'ビルの明かりが、ひとつ、またひとつと黒に飲まれていく。\n' +
  '夜そのものより濃い影が、こちらへ近づいていた。',

  '同僚「……あれですか」\n' +
  '主人公「ああ。前回、僕たちを襲ったやつだ」\n' +
  '同僚「逃げますか？」\n' +
  '主人公は首を振る。\n' +
  '主人公「逃げても、また繰り返すだけだ」\n' +
  '同僚は震える手を握りしめる。\n' +
  ...
  nodes: {
    ...
    endNormal: {
      text:
        ...
        '主人公「普通、か」\n' +
        '主人公は苦笑する。\n' +
        '前回の記憶を持っている自分には、普通という言葉が少し遠かった。\n' +
        '同僚「また来週、少しずつ進めましょう」\n' +
        '主人公「ああ」\n' +
        '夢の話は、まだ切り出せなかった。',
      choices: [{ label: '……', next: null, effects: () => {} }]
